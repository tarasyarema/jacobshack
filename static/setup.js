...
let lights = {
	directional_1: new THREE.DirectionalLight(0xff59ac, 0.3),
	directional_2: new THREE.DirectionalLight(0x00e1ff, 0.3),
...
let cube_material = new THREE.MeshPhongMaterial({ color: 0xffffff });
